...
###############################################################################
#
# __parse_uids_fasta_file__.py - description!
#
###############################################################################
# #
...
def doWork( args ):
    ...
    #-----
    # clean up gut_oral_contig_uniq.fna
    for seq_record in SeqIO.parse(args.fasta_file,"fasta"):
        sep = seq_record.id.split("-")
        uid = sep[-1].rstrip()
        if uid not in contam_ids:
            #print ">"+seq_record.id
            print ">"+seq_record.id 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f','--fasta_file', help="gut_oral_contigs_uniq.fna")
