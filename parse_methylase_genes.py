...
class annotationDB(object):
    ...
    def addMethylaseGene(self,l):
        ...
        or found_string("methyltransferase",line.cog_annotation) or found_string("methyltransferase",line.annotation) or found_string("restriction",line.annotation) or found_string("restriction",line.cog_annotation):
